...
for current_indiv in indiv_ids:
    ...
    features_all_indivs_per_hour[current_indiv] = \
...
for current_indiv in indiv_ids:
    if start:
        ...
        bigdf = pd.concat([bigdf, features_all_indivs[current_indiv][pca_vars]])
pca = PCA()
pca = pca.fit(bigdf)
#%%
# Define some models
...
def get_lagged_feature_matrix_and_target_mood(current_indiv, days_prior, 
                                              features_all_indivs_per_hour = features_all_indivs_per_hour,
                                              features_all_indivs_per_day = features_all_indivs_per_day,
                                              do_pca = True):
    df_hour = features_all_indivs_per_hour[current_indiv]
...
def get_variable_names_for_big_x(days_prior, do_pca = True):
